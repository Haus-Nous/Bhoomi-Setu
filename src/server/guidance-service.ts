...
function forResult(caseId: string, item: VerificationItem, documents: DocumentItem[], locale: Locale): GuidanceItem {
  ...
  const explanation = potential ? area ? text(locale, "Review the historical/supporting record and survey entry together. Bhoomi Setu does not determine which value is correct.", "ऐतिहासिक/सहायक रिकॉर्ड और सर्वे प्रविष्टि को साथ देखें। Bhoomi Setu यह तय नहीं करता कि कौन सा मूल्य सही है।") : text(locale, "Review the genealogy/family record against the current holder and survey context. Bhoomi Setu does not determine ownership or inheritance.", "वंशावली/परिवार रिकॉर्ड की वर्तमान धारक और सर्वे संदर्भ से तुलना करें। Bhoomi Setu स्वामित्व या विरासत तय नहीं करता।") : insufficient ? text(locale, "More comparable information is needed before this check can be assessed.", "इस जाँच का आकलन करने से पहले और तुलनीय जानकारी चाहिए।") : text(locale, "No immediate action is suggested for this check based on the compared synthetic records.", "तुलना किए गए सिंथेटिक रिकॉर्ड के आधार पर इस जाँच के लिए कोई तत्काल कदम नहीं सुझाया गया है।");
  return { id: `${caseId}-guidance-${item.id}`, caseId, verificationResultId: item.id, ruleId: item.ruleId, title, explanation, priority: potential ? area ? 10 : 20 : insufficient ? area ? 70 : 80 : area ? 90 : 100, status, documentIds: relatedDocuments(item, documents), checklist: checklist(item.ruleId, status, locale), caution: text(locale, "This is preparation only. Bhoomi Setu cannot decide which record is legally correct, submit a request, or make an official correction.", "यह केवल तैयारी के लिए है। Bhoomi Setu यह तय नहीं कर सकता कि कौन सा रिकॉर्ड कानूनी रूप से सही है, अनुरोध जमा कर सकता है, या आधिकारिक सुधार कर सकता है।"), sourceVerificationResultIds: [item.id] };
}

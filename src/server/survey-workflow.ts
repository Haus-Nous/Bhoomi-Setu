...
export const surveyWorkflow: Record<SurveyWorkflowStage["id"], SurveyWorkflowStage> = {
  SYNTHETIC_CASE_CREATED: { id: "SYNTHETIC_CASE_CREATED", label: { en: "Synthetic case created", hi: "सिंथेटिक केस बनाया गया" }, explanation: { en: "This local demo case is ready for synthetic records. No government process has started.", hi: "यह स्थानीय डेमो केस सिंथेटिक रिकॉर्ड के लिए तैयार है। कोई सरकारी प्रक्रिया शुरू नहीं हुई है।" }, relevantInformation: ["synthetic case details", "synthetic Khata/Khesra identifiers"], safeActions: ["add or inspect a synthetic record"], nextStage: "SYNTHETIC_RECORDS_READY", caution: { en: "This stage is a Bhoomi Setu demo label, not an official survey status.", hi: "यह चरण Bhoomi Setu का डेमो लेबल है, आधिकारिक सर्वे स्थिति नहीं।" } },

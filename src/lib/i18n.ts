...
type Translation = {
  ...
  home: Record<"eyebrow" | "trustEyebrow" | "title" | "lead" | "safety" | "start" | "step1" | "step2" | "step3" | "step4" | "forWho" | "forWhoTitle" | "forWhoDetail" | "does" | "doesDetail" | "doesNot" | "doesNotDetail" | "howTitle" | "createTitle" | "createDetail" | "documentsTitle" | "documentsDetail" | "verifyTitle" | "verifyDetail", string>;
...
const en: Translation = {
  ...
  footer: "© 2026 Bhoomi Setu · Independent prototype · No real government records are used.",
  ...
  survey: { header: "Survey record", subtitle: "A citizen-friendly view of a synthetic Khanapuri Parcha (खानापुरी पर्चा).", emptyTitle: "No survey record yet", emptyDetail: "Add a synthetic survey record when it is available.", recordTitle: "Synthetic Khanapuri Parcha (खानापुरी पर्चा) review", recordDetail: "Synthetic demonstration record — not a government record.", compare: "Compare with my records", comparisonFound: "What the deterministic comparison found", noDifferences: "No possible differences found", noDifferencesDetail: "Bhoomi Setu does not have a potential discrepancy to prepare from this record.", reviewNext: "What should I review next?", reviewEvidence: "Review all evidence", recordedName: "Recorded name", recordedArea: "Recorded area", mapReference: "Map reference", stage: "Survey stage" },
  verification: { pageTitle: "Check your records", pageSubtitle: "Bhoomi Setu compares available synthetic records. It does not make legal conclusions.", summaryTitle: "Record comparison summary", passed: "No obvious discrepancy found", potentialIssue: "Possible mismatch found", insufficientEvidence: "Not enough comparable information", passDetail: "No obvious discrepancy was found in the compared records.", potentialIssueDetail: "A possible mismatch was found. Review the records below.", insufficientEvidenceDetail: "Not enough comparable information is available to make this check.", whyFlagged: "Why was this flagged?", comparedRecords: "Compared records", recordA: "Record A", recordB: "Record B", source: "Source", reference: "Comparison reference", notAvailable: "Not available in the compared records", caution: "Important to know", cautionDetail: "A possible mismatch is not proof that a record is incorrect. Bhoomi Setu does not establish legal ownership. Verify important decisions against appropriate official records and processes.", allChecks: "All comparison checks", reviewDifferences: "Review the records that differ", allChecksTitle: "Every result, with its comparison reference", noResultsTitle: "No comparison results yet", noResultsDetail: "Bhoomi Setu needs comparable synthetic records before it can show a check.", overviewLink: "Review comparisons" },
  guidance: { header: "Prepare your next review", subtitle: "Use this guide to compare records and get organised. Nothing is submitted from Bhoomi Setu.", emptyTitle: "No preparation guidance yet", emptyDetail: "Add comparable synthetic records before Bhoomi Setu can suggest what to review.", prepare: "Prepare for review", reviewFirst: "items to review first", noUrgency: "No urgent comparison review suggested", startReview: "Start with the possible differences below, then keep the related synthetic records together.", needInformation: "The available records need more comparable information before Bhoomi Setu can assess the checks.", review: "Review", information: "Information", found: "What Bhoomi Setu found", unavailable: "The related comparison result is not available.", compared: "Compared", reviewNext: "What you can review next", relatedRecords: "Related existing records", checklist: "Preparation checklist", cannot: "What Bhoomi Setu cannot do", preparation: "Preparation, not submission", preparationDetail: "Use these local checklist notes to prepare for your own review. Bhoomi Setu does not file, submit, or correct any government record.", ready: "Ready to review", moreInfo: "More information needed", noAction: "No immediate action" },
  packet: { header: "Prepare review packet", subtitle: "Draft for review — not submitted to any government system.", prepared: "Prepared for review", draft: "Draft for review", failed: "This review packet could not be prepared.", preparedMessage: "Prepared for review. This packet has not been submitted to any government system.", savedMessage: "Draft saved locally in this synthetic case.", compared: "Compared values", supporting: "Supporting synthetic records", notes: "Citizen notes", request: "Clarification request", preparing: "Preparing your synthetic draft…", safetyTitle: "Preparation only", safetyDetail: "This packet is a synthetic review aid. Bhoomi Setu does not submit it, determine ownership, or correct any government record.", noPacket: "No review packet yet", noPacketDetail: "Choose a possible difference first to prepare a synthetic review packet." },
...
const hi: Translation = {
  ...
  footer: "© 2026 Bhoomi Setu · स्वतंत्र प्रोटोटाइप · किसी वास्तविक सरकारी रिकॉर्ड का उपयोग नहीं किया जाता।",
  ...
  labels: { synthetic: "सिंथेटिक डेमो", viewDetails: "विवरण देखें", confidence: "विश्वास", evidence: "साक्ष्य", backToCase: "मेरे केस पर लौटें", mock: "केवल मॉक — कुछ भी जमा नहीं होगा", source: "स्रोत", notAvailable: "उपलब्ध नहीं", optional: "वैकल्पिक", caseHeader: "आपका भूमि केस", skip: "मुख्य सामग्री पर जाएँ", homeLabel: "Bhoomi Setu होम", primaryNav: "मुख्य नेविगेशन", caseNav: "केस अनुभाग", contextNav: "साक्ष्य और संदर्भ", chooseLanguage: "भाषा बदलें" },
...
export function localizedEarthObservationPresentation(locale: Locale) {
  ...
  return {
    ...
    insufficientSummary: hi ? "इस केस के लिए दो तुलनीय सिंथेटिक संदर्भ छवियां उपलब्ध नहीं हैं। Bhoomi Setu कोई निष्कर्ष नहीं बनाता।" : "Two comparable synthetic context images are not available for this case. Bhoomi Setu does not infer a change.",
